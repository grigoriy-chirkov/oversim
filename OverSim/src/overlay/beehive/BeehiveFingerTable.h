...
/**
 * @file BeehiveFingerTable.h
 * @author Markus Mauch, Ingmar Baumgart
 */

#ifndef __BEEHIVEFINGERTABLE_H_
#define __BEEHIVEFINGERTABLE_H_
...
/**
 * Beehive's finger table module
 *
 * This modul contains the finger table of the Beehive implementation.
 *
 * @author Markus Mauch, Ingmar Baumgart
 * @see Beehive
 */
class BeehiveFingerTable : public cSimpleModule
{
  public:
