 ...
 * @see BaseOverlay
 */
class Beehive : public BaseBeehive
{
  public:
    virtual ~Beehive();
    ...
    void handleStateMessage(BeehiveStateMessage* msg);
  ...
  protected:
    ...
    void handleBeehiveJoinCall(BeehiveJoinCall* call);

    void handleRequestStateCall(BeehiveRequestStateCall* call);

    void handleRequestRepairCall(BeehiveRequestRepairCall* call);

    void handleRpcResponse(BaseResponseMessage* msg,
                           cPolymorphic* context, int rpcId,
                           simtime_t rtt);

    void handleBeehiveJoinResponse(BeehiveJoinResponse* response);

    void handleRequestStateResponse(BeehiveRequestStateResponse* response);

    void handleRequestRepairResponse(BeehiveRequestRepairResponse* response);

    void handleRequestLeafSetResponse(BeehiveRequestLeafSetResponse* response);

    void handleRequestRoutingRowResponse(BeehiveRequestRoutingRowResponse* response);
     ...
     */
    std::vector<BeehiveStateMsgHandle> stReceived;
    std::vector<BeehiveStateMsgHandle>::iterator stReceivedPos;
    ...
    std::vector<BeehiveSendState*> sendStateWait;
