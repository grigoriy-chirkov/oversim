...
/**
 * BeehiveLeafSet module
 *
 * This module contains the LeafSet of the Beehive implementation.
 *
 * @author Felix Palmen, Bernhard Heep
 * @see Beehive
 */
class BeehiveLeafSet : public BeehiveStateObject
{
  public:
     ...
     *
     * @param numberOfLeaves Beehive configuration parameter
     ...
     * @param overlay pointer to the beehive main module
     */
     ...
     */
    BeehiveNewLeafsMessage* getNewLeafsMessage(void);
  ...
  private:
    ...
    simtime_t repairTimeout;
    BaseBeehive* overlay; /**< pointer to the main beehive module */
